    ...
    rocket::custom(&rocket_config)
        ...
        .mount(
            ...
            rocket::routes![
                ...
                route::owner::event::leader::event_leader_presence_pool,
                route::owner::event::leader::event_leader_presence_list,
                route::owner::event::leader::event_leader_presence_add,
                route::owner::event::leader::event_leader_presence_remove,
                route::owner::event::supporter::event_supporter_presence_pool,
                route::owner::event::supporter::event_supporter_presence_list,
                route::owner::event::supporter::event_supporter_presence_add,
                route::owner::event::supporter::event_supporter_presence_remove,
                route::owner::event::participant::event_participant_presence_pool,
                route::owner::event::participant::event_participant_presence_list,
                route::owner::event::participant::event_participant_presence_add,
                route::owner::event::participant::event_participant_presence_remove,
