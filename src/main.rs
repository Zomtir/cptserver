...
struct AppState {
    db: mysql::Pool,
    admin_session: Arc<Mutex<Option<String>>>,
    user_sessions: Arc<Mutex<HashMap<String, session::UserSession>>>,
    event_sessions: Arc<Mutex<HashMap<String, session::EventSession>>>,
}
