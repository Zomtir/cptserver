...
pub fn user_detailed(conn: &mut PooledConn, user_id: u64) -> Result<User> {
    let stmt = conn.prep(
        "SELECT
            ...
            lm.issued AS license_main_issued,
            ...
            le.issued AS license_extra_issued,
    ...
    let user = User {
        ...
        license_main: row
            ...
            .map(|id| License {
                ...
                issued: row.take("license_main_issued").unwrap(),
        ...
        license_extra: row
            ...
            .map(|id| License {
                ...
                issued: row.take("license_extra_issued").unwrap(),
