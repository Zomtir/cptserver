...
pub fn term_info(State(state): State<AppState>, session: UserSession, term_id: u64) -> Result<Json<Term>> {
    crate::permission::require_right(session.right.right_club_read)?;
...
pub fn term_create(State(state): State<AppState>, session: UserSession, term: Json<Term>) -> Result<String> {
...
pub fn term_edit(State(state): State<AppState>, session: UserSession, term_id: u32, term: Json<Term>) -> Result<()> {
    crate::permission::require_right(session.right.right_club_write)?;
...
pub fn term_delete(State(state): State<AppState>, session: UserSession, term_id: u32) -> Result<()> {
    crate::permission::require_right(session.right.right_club_write)?;
