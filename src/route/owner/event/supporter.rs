...
#[rocket::get("/owner/event_supporter_registration_list?<event_id>")]
...
#[rocket::get("/owner/event_supporter_filter_list?<event_id>")]
...
#[rocket::head("/owner/event_supporter_filter_edit?<event_id>&<user_id>&<access>")]
...
#[rocket::head("/owner/event_supporter_filter_remove?<event_id>&<user_id>")]
