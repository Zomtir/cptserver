...
ALTER TABLE `courses` ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`club_id`) REFERENCES `clubs`(`club_id`) ON UPDATE CASCADE;
...
ALTER TABLE `clubs` CHANGE `description` `description` VARCHAR(100) NULL DEFAULT NULL;
